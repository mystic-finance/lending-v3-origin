...
deploy-plume3-verify-impl :; forge verify-contract --watch  0xEd2D5f8F6bE71F740c89dEf37c6535f7A07B6F83 src/core/instances/L2PoolInstance.sol:L2PoolInstance  --rpc-url plume3 --verifier blockscout --optimizer-runs 200 --compiler-version "v0.8.20" --verifier-url 'https://test-explorer.plumenetwork.xyz/api'
# --show-standard-json-input > etherscan.json
deploy-plume3-verify :; forge verify-contract 0xd7ecf5312aa4FE7ddcAAFba779494fBC5f5f459A src/core/contracts/protocol/libraries/aave-upgradeability/InitializableImmutableAdminUpgradeabilityProxy.sol:InitializableImmutableAdminUpgradeabilityProxy --rpc-url plume3 --verifier blockscout --verifier-url 'https://test-explorer.plumenetwork.xyz/api/'
