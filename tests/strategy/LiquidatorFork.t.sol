...
// contract FlashMintLiquidatorForkTest is TestnetProcedures {
//   // Test Addresses
...
//   uint256 internal constant LIQUIDATION_AMOUNT = 10000 * 10 ** 6;
...
//     collateralToken = MockERC20(0xD630fb6A07c9c723cf709d2DaA9B63325d0E0B73); //new MockERC20('CollateralToken', 'CLT', 18);
//     borrowedToken = MockERC20(0x3938A812c54304fEffD266C7E2E70B48F9475aD6); //new MockERC20('BorrowToken', 'BRT', 18);

//     // Deploy mock contracts
//     lendingPool = IPool(0xd5b3495C5e059a23Bea726166E3C46b0Cb3b42Ab); //IPool(address(contracts.poolProxy));
...
//     swapController = new MockSwapController(address(ambientSwapper));
//     // AaveV3Flashloaner flashLoanWrapper = new AaveV3Flashloaner(
//     //   address(lendingPool.ADDRESSES_PROVIDER())
//     // );
//     flashLender = FlashLoanController(0x5fA6836e652d7d43089EAc7df3a8360b5ccdCf9A); //new FlashLoanController(address(flashLoanWrapper));
...
//     _updatePrice(address(collateralToken), 1800e8 / 5); // divide price by 5
...
//     _updatePrice(address(collateralToken), 1600e8); // divide price by 5
//     vm.startPrank(liquidator);
//     liquidatorContract.liquidate(
//       address(borrowedToken),
//       address(collateralToken),
...
//       LIQUIDATION_AMOUNT,
//       false,
//       abi.encode(address(borrowedToken), address(collateralToken), 300) // Swap path
//     );
//     vm.stopPrank();
...
//     vm.expectRevert('OnlyLiquidator');
//     liquidatorContract.liquidate(
//       address(borrowedToken),
//       address(collateralToken),
//       borrower,
...
//     vm.startPrank(liquidator);
//     vm.expectRevert('NoDebtToLiquidate');
//     liquidatorContract.liquidate(
//       address(borrowedToken),
//       address(collateralToken),
//       borrower,
...
//     vm.startPrank(liquidator);
//     vm.expectRevert('AmountExceedsDebt');
//     liquidatorContract.liquidate(
//       address(borrowedToken),
//       address(collateralToken),
//       borrower,
