  ...
  function getLibraryString2(LibrariesReport memory report) internal pure returns (string memory) {
    return
      string(
        abi.encodePacked(
          ',',
          'src/core/contracts/protocol/libraries/logic/FlashLoanLogic.sol:FlashLoanLogic:',
          vm.toString(report.flashLoanLogic),
          ',',
          'src/core/contracts/protocol/libraries/logic/LiquidationLogic.sol:LiquidationLogic:',
          vm.toString(report.liquidationLogic),
          ',',
          'src/core/contracts/protocol/libraries/logic/PoolLogic.sol:PoolLogic:',
          vm.toString(report.poolLogic),
          ',',
          'src/core/contracts/protocol/libraries/logic/SupplyLogic.sol:SupplyLogic:',
