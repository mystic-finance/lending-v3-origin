...
- [Senior Tranche (Vault)](https://github.com/mystic-finance/aave-stk-gov-v3/tree/senior-vault): An insurance layer that covers losses and replenishes liquidity in the pool when needed.
