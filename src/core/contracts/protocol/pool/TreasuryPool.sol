 ...
 */
abstract contract TreasuryPool is Pool, IL2Pool {

  /**
   * @dev Only approved liquidator can call functions marked by this modifier.
   */
  modifier onlyTreasuryLiquidator() {
    _onlyTreasuryLiquidator();
    _;
  }
   ...
   */
  modifier onlyTreasuryPoolUser() {
    _onlyTreasuryPoolUser();
    _;
  }

  function _onlyTreasuryPoolUser() internal view virtual {
    require(
      IACLManager(ADDRESSES_PROVIDER.getACLManager()).isTreasuryPoolUser(msg.sender),
      Errors.CALLER_NOT_POOL_ADMIN
    );
  }

  function _onlyTreasuryLiquidator() internal view virtual {
    require(
      IACLManager(ADDRESSES_PROVIDER.getACLManager()).isTreasuryLiquidator(msg.sender),
      Errors.CALLER_NOT_POOL_ADMIN
    );
  }

  /// @inheritdoc IL2Pool
  function supply(bytes32 args) external override onlyTreasuryPoolUser {
  ...
  /// @inheritdoc IL2Pool
  function supplyWithPermit(bytes32 args, bytes32 r, bytes32 s) external override onlyTreasuryPoolUser {
  ...
  /// @inheritdoc IL2Pool
  function withdraw(bytes32 args) external override onlyTreasuryPoolUser returns (uint256) {
  ...
  /// @inheritdoc IL2Pool
  function borrow(bytes32 args) external override onlyTreasuryPoolUser {
  ...
  /// @inheritdoc IL2Pool
  function repay(bytes32 args) external override onlyTreasuryPoolUser returns (uint256) {
  ...
  /// @inheritdoc IL2Pool
  function repayWithPermit(bytes32 args, bytes32 r, bytes32 s) external override onlyTreasuryPoolUser returns (uint256) {
    (
      address asset,
      uint256 amount,
  ...
  /// @inheritdoc IL2Pool
  function repayWithATokens(bytes32 args) external override onlyTreasuryPoolUser returns (uint256) {
    (address asset, uint256 amount, uint256 interestRateMode) = CalldataLogic.decodeRepayParams(
      _reservesList,
      args
    );
  ...
  /// @inheritdoc IL2Pool
  function swapBorrowRateMode(bytes32 args) external override onlyTreasuryPoolUser {
  ...
  /// @inheritdoc IL2Pool
  function rebalanceStableBorrowRate(bytes32 args) external override  onlyTreasuryPoolUser{
  ...
  /// @inheritdoc IL2Pool
  function setUserUseReserveAsCollateral(bytes32 args) external override  onlyTreasuryPoolUser{
  ...
  /// @inheritdoc IL2Pool
  function liquidationCall(bytes32 args1, bytes32 args2) external override onlyTreasuryLiquidator {
    (
