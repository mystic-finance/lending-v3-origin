...
//   function _flashLoanInternal(FlashLoanParams memory _flashLoanParams, uint256 _amountIn) internal {
...
//         10 ** liquidateParams.borrowedUnderlying.decimals()) * (BASIS_POINTS + slippageTolerance)) /
//         BASIS_POINTS;
...
//       ERC20(_flashLoanParams.collateralUnderlying).safeApprove(address(swapController), maxIn);
